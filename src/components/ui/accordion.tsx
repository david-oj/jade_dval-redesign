  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <Plus
          className={cn(
            "block xs:min-w-6 max-xs:max-w-4 max-xs:min-w-4 max-xs:max-h-4  rounded-xs xs:rounded-sm pointer-events-none bg-primary text-white",
        ...
        <Minus
          className={cn(
            "hidden  xs:min-w-6 max-xs:max-w-4 max-xs:min-w-4 max-xs:max-h-4  rounded-xs xs:rounded-sm pointer-events-none bg-primary text-white",
