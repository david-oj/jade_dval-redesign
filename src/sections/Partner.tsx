...
const Partner = () => {
  return (
    <section className='md:mx-25 max-md:px-6 mt-4.5 sm:mt-[82px] mb-7 sm:mb-[71px]'>
        <div className="relative bg-primary lg:h-[435px] rounded-[28px] flex max-md:flex-col justify-between">
            <div className=" flex-1 flex flex-col gap-4 lg:p-21 md:p-10 px-4 py-5 max-sm:text-center max-sm:items-center ">
            ...
            <div className="absolute right-0 h-f lg:max-w-[600px] overflow-hidden max-sm:hidden md:max-w-[400px]">
